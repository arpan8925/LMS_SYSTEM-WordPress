...
function digit_addons($active_tab)
{
    ...
    $data = array(
        'purchased' => array (
            'direstapi' =>  array (
                    'name'                  => 'REST API',
                    'thumbnail'             => 'https://digits.unitedover.com/wp-content/uploads/2019/08/add8-rest-api.png',
                    'desc'                  => 'This Digits addon allows you to use REST API calls for its functions',
                    'location'              => 'https://digits.unitedover.com/addon/rest-api/?utm_source=digits-wp-settings&utm_medium=addon-page',
                    'price'                 => '$19.00',
                    'plugin'                => 'digrestapi/digrestapi.php',
                    'path'                  => 'digrestapi/digrestapi.php',
                    'allow_direct_install'  => 0,
                    'multi_site'            => 0
            ),
            'digcountrygateways' =>  array (
                    'name'                  => 'Country Based SMS Gateway',
                    'thumbnail'             => 'https://digits.unitedover.com/wp-content/uploads/2019/08/add6-country-based-gateway.png',
                    'desc'                  => 'Setup different SMS gateways for different countries to minimize cost and increase reachability with ease.',
                    'location'              => 'https://digits.unitedover.com/addon/country-based-message-gateway/?utm_source=digits-wp-settings&utm_medium=addon-page',
                    'price'                 => '$14.00',
                    'plugin'                => 'digcountrygateways/digcountrygateways.php',
                    'path'                  => 'digcountrygateways/digcountrygateways.php',
                    'allow_direct_install'  => 0,
                    'multi_site'            => 0
            
            ),
            'digadvlogic' =>  array (
                    'name'                  => 'Additional Fields & Logic Builder',
                    'thumbnail'             => 'https://digits.unitedover.com/wp-content/uploads/2018/12/add3-advance-fields-and-logic-form-1.png',
                    'desc'                  => 'Enhance the capabilities of your form by additional and advanced fields, or build a logic to hide/show some field when that particular logic is met.',
                    'location'              => 'https://digits.unitedover.com/addon/additional-fields-logical-form/?utm_source=digits-wp-settings&utm_medium=addon-page',
                    'price'                 => '$14.00',
                    'plugin'                => 'digadvlogic/digadvlogic.php',
                    'path'                  => 'digadvlogic/digadvlogic.php',
                    'allow_direct_install'  => 0,
                    'multi_site'            => 0
            ...
            'digfilter' =>  array (
                    'name'                  => 'Email Filter',
                    'thumbnail'             => 'https://digits.unitedover.com/wp-content/uploads/2019/08/add5-email-filter.png',
                    'desc'                  => 'Want to stop emails from some specific domain or stop spam? With this filter out the domains you don\'t want or whitelist some.',
                    'location'              => 'https://digits.unitedover.com/addon/email-filter/?utm_source=digits-wp-settings&utm_medium=addon-page',
                    'price'                 => '$9.00',
                    'plugin'                => 'digfilter/digfilter.php',
                    'path'                  => 'digfilter/digfilter.php',
                    'allow_direct_install'  => 0,
                    'multi_site'            => 0
            
            ),
            'digoneclickls' =>  array (
                    'name'                  => 'One Click Login/Signup',
                    'thumbnail'             => 'https://digits.unitedover.com/wp-content/uploads/2019/08/add4-one-click-login-signup.png',
                    'desc'                  => 'Have just one form for both login and signup process using mobile number.',
                    'location'              => 'https://digits.unitedover.com/addon/one-click-login-signup/?utm_source=digits-wp-settings&utm_medium=addon-page',
                    'price'                 => '$9.00',
                    'plugin'                => 'digoneclickls/digoneclickls.php',
                    'path'                  => 'digoneclickls/digoneclickls.php',
                    'allow_direct_install'  => 0,
                    'multi_site'            => 0
            
            ),
            'digmergphne' =>  array (
                    'name'                  => 'Merge Phone Number',
                    'thumbnail'             => 'https://digits.unitedover.com/wp-content/uploads/2019/08/add2-merge-billing-and-account-mobile-field.png',
                    'desc'                  => 'Merge your billing phone and account phone from checkout page and every other place.',
                    'location'              => 'https://digits.unitedover.com/addon/merge-phone-number/?utm_source=digits-wp-settings&utm_medium=addon-page',
                    'price'                 => '$9.00',
                    'plugin'                => 'digmergphne/digmergphne.php',
                    'path'                  => 'digmergphne/digmergphne.php',
                    'allow_direct_install'  => 0,
                    'multi_site'            => 0
            ...
            'digapprove' =>  array (
                    ...
                    'thumbnail'             => 'https://digits.unitedover.com/wp-content/uploads/2020/03/add11-account-approval-1.png',
                    'desc'                  => 'Merge your billing phone and account phone from checkout page and every other place.',
                    'location'              => 'https://digits.unitedover.com/addon/account-approval/?utm_source=digits-wp-settings&utm_medium=addon-page',
                    'price'                 => '$9.00',
                    'plugin'                => 'digapprove/digapprove.php',
                    'path'                  => 'digapprove/digapprove.php',
                    'allow_direct_install'  => 0,
                    'multi_site'            => 0
            
            ),
            'additional-gateways' =>  array (
                    'name'                  => 'Additional Gateways',
                    'thumbnail'             => 'https://digits.unitedover.com/wp-content/uploads/2020/01/add10-additional-gateways.png',
                    'desc'                  => 'Addon contains 105+ additional SMS Gateways',
                    'location'              => 'https://digits.unitedover.com/addon/account-approval/?utm_source=digits-wp-settings&utm_medium=addon-page',
                    'price'                 => '$9.00',
                    'plugin'                => 'additional-gateways/additional-gateways.php',
                    'path'                  => 'additional-gateways/additional-gateways.php',
                    'allow_direct_install'  => 0,
                    'multi_site'            => 0
            
            ),
            'digpagelock' =>  array (
                'name'                  => 'Forced Login Page Lock',
                'thumbnail'             => 'https://digits.b-cdn.net/wp-content/uploads/2019/08/add7-page-lock-600x375.png',
                'desc'                  => 'Restrict access to your website, lock some specific page or posts or even your WooCommerce’s product or checkout page to logged in users.',
                'location'              => 'https://digits.unitedover.com/addon/forced-login-page-lock/?utm_source=digits-wp-settings&utm_medium=addon-page',
                'price'                 => '$19.00',
                'plugin'                => 'digpagelock/digpagelock.php',
                'path'                  => 'digpagelock/digpagelock.php',
                'allow_direct_install'  => 0,
                'multi_site'            => 0
        	),
            'digbuilder' =>  array (
                    'name'                  => 'Login-Signup Page/Popup Builder',
                    'thumbnail'             => 'https://digits.unitedover.com/wp-content/uploads/2020/01/add9-builder.png',
                    'desc'                  => 'This Digits addon allows you to create custom Login/Signup Page/Modal',
                    'location'              => 'https://digits.unitedover.com/addon/builder/?utm_source=digits-wp-settings&utm_medium=addon-page',
                    'price'                 => '$9.00',
                    'plugin'                => 'digbuilder/digbuilder.php',
                    'path'                  => 'digbuilder/digbuilder.php',
                    'allow_direct_install'  => 0,
                    'multi_site'            => 0
                                    ...
                                    <input type="hidden" class="dig_plugin_slug"
                                        ...
                                        <div class="digmodifyaddon icon-group icon-group-dims" type="-1"></div>
                                            ...
                                            <div class="dig_ngmc updatetabview icon-setting icon-setting-dims <?php echo $active_tab == $addon_settings ? 'dig-nav-tab-active' : ''; ?>"
                                                 tab="<?php echo $basename[0]; ?>tab"></div>
...
function digit_activation($form = true)
{
    ...
    $code = '8699958a-77f3-4db8-9422-126b0836e1c5';
    $license_type = 1;
