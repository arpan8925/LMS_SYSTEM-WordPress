...
function amm_drcfw_style_n_script() {
	if( current_user_can('editor') || current_user_can('administrator') ) {
		...
		<script type="text/javascript">
			...
			if (show_msg !== '0') {
				var options = {view_src: "সিকিউরিটির জন্যে এই অপশন বন্ধ করে দেওয়া হয়েছে!", inspect_elem: "সিকিউরিটির জন্যে ইন্সপেক্ট এলিমেন্ট বন্ধ করে দেওয়া হয়েছে!", right_click: "সিকিউরিটির জন্যে রাইট ক্লিক বন্ধ করে দেওয়া হয়েছে!", copy_cut_paste_content: "সিকিউরিটির জন্যে কাট/কপি বন্ধ করে দেওয়া হয়েছে!", image_drop: "সিকিউরিটির জন্যে ছবি ড্রাগ এবং ড্রপ বন্ধ করে দেওয়া হছে!" }
			} else {
				var options = '';
			}
