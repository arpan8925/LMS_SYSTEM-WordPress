	...
	<div class="sui-box-settings-row sui-upsell-row">
		...
		$this->admin_notices->show_inline(
			sprintf( /* translators: %s: upsell modal href link */
				__( "With our pro version of Hummingbird you can super-compress your files and then host them on our blazing-fast CDN. Get CDN as part of a WPMU DEV membership with 24/7 support and lots of handy site management tools.  <a href='%s' target='_blank'>UNLOCK NOW WITH PRO!</a>", 'wphb' ),
